...
export function CommandWorkspace({
  ...
  return (
    ...
    >
        ...
        <div className="border-b px-3.5 py-3.5">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <p className="font-mono text-[10px] text-muted-foreground">{cmds.length} COMMANDS</p>
            </div>
          </div>
          {cmds.length > 5 && (
          ...
          {invocationPending && (
            ...
            >
              ...
              <span>
                正在执行 <span className="font-mono text-foreground">{active?.name}</span>
                ，完成后可切换命令。
              </span>
            </div>
          )}
      ...
      <div className="min-w-0" aria-busy={invocationPending}>
        {active && (
          <CmdPanel
