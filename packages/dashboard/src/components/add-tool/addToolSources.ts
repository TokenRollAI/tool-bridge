...
export const ADD_SOURCES: readonly AddSource[] = [
  {
    kind: 'catalog',
    title: '内置集成',
    blurb: '选择当前网关提供的集成，按提示配置连接与凭证。',
    icon: Blocks,
  },
  {
    kind: 'mcp',
    title: 'MCP Server',
    blurb: '连接 MCP 服务，支持账号授权与 API 凭证。',
    icon: Plug,
    mountKind: 'mcp',
  },
  {
