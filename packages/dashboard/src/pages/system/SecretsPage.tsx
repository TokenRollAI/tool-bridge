          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground">
                已加载 {all.length} 个引用名{needle && `，匹配 ${items.length} 个`}
              </p>
            </div>
          </div>
                  ...
                  <TableRow key={secret.name} className="group">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-1.5">
                            ...
                            <CopyButton value={secret.name} label="复制引用名" />
                          </div>
                    ...
                    <TableCell className="py-4">
                      <div className="flex justify-end gap-1.5">
                        <Button variant="outline" size="xs" onClick={() => openEditor(secret.name)}>
                          <RefreshCw />
                          轮换
                        </Button>
                        <ConfirmAction
        ...
        <div className="grid gap-5 px-5 py-5 sm:px-6">
          ...
          {(isRotation || mayRotateUnloaded) && (
            <div className="flex items-start gap-2.5 rounded-lg border border-warn/30 bg-warn/[0.045] px-3 py-2.5 text-xs">
              <RefreshCw className="mt-0.5 size-3.5 shrink-0 text-warn" aria-hidden="true" />
              <p>
