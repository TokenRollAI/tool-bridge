...
- `pnpm verify` — typecheck + lint + 单测 + 集成测试一把过(当前 644 core + 140 cli + 12 sdk 单测,108 gateway 默认集成 + 6 opt-in skipped,23 server,8 plugin-feishu;根 `test:integration` 含 gateway + server + plugin-feishu)。
